...
これは、そのPasteが **同じReport内で以前に行われたCopy/Cutと照合できなかった** ことだけを意味します。しかしながら、**なぜこれほど非内部貼り付けの割合が高いのか、執筆者への確認等の対応が必要**と考えられます。このような目的のために、**Verifierの技術表示タブ** から執筆過程のより詳細を表示することができます(図中赤枠表示)。	
