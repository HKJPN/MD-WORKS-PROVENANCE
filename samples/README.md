...
正常に最終化（ファイナライズ）されたアカデミックレポートです。
...
**「非内部貼り付け」は、AIによる生成、盗用、不正行為、または整合性が損なわれていることを必ずしも意味するものではありません。**　しかしながら、なぜこれほど非内部貼り付けの割合が高いのか、執筆者への確認等の対応が必要と考えられます。

## 03-integrity-broken-report.html

最終化のあとに、意図的に変更が加えられたレポートです。
